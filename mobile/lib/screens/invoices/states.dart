...
class _InvoicesEmptyState extends StatelessWidget {
  const _InvoicesEmptyState({required this.onAddSale, this.message});
    ...
    return ListView(
      ...
      children: [
        ...
        Center(
          child: Text(
            message ??
                'Your issued invoices will appear\nhere. Start by creating a new invoice.',
...
class _InvoicesMainState extends StatelessWidget {
  const _InvoicesMainState({
            ...
            child: ListView(
              ...
              if (sections.isEmpty) ...[
                Container(
                  ...
                  child: const Text(
                    'No matching invoices yet. You can load more or change your search.',
                    style: TextStyle(
                      fontSize: 14,
                      color: Color(0xFF64748B),
              ...
              for (final section in sections) ...[
                _InvoicesSectionHeader(text: _sectionTitle(section.key)),
                const SizedBox(height: 14),
                ...section.value.map(
                  (sale) => _InvoicesTile(
                    sale: sale,
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: loadingMore
                      ...
                      : Text(
                          hasMore ? 'Load more' : 'No more invoices',
